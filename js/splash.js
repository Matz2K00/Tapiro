...
if(getCookie("splash") == ""){  // Verification if splash's cookie isset
  ...
  setTimeout(function(){ document.getElementById("alien").src = "img/Alieno.gif";document.getElementById("alien").style = "padding-left:20px!important;width: 210px!important;"; }, 500);
  setTimeout(function(){ document.getElementById("alien").src = "img/Alieno.png";document.getElementById("alien").style = ""; }, 2000);
}